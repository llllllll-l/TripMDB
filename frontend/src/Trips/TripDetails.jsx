...
function TripDetails({ currentUser }) { //add user as prop,
        ...
        {trips ? (
            ...
            {trips.map((trip, index) => (
              <div key={index} className="trip">
                  <h4>Trip {index + 1}</h4>
                  <p><strong>Movie:</strong> {trip.movie.title}</p>
                  ...
                  <ul>
                    ...
                    {trip.locations.map((locationObject, idx) => (
                        <li key={idx}>
                            ...
                            <strong> Country:</strong> {locationObject.location.country}, 
                            <strong> Location Name:</strong> {locationObject.location.locationName}
                        </li>
                    ))}
                  </ul>
              </div>
